<template>
  <div>
        ...
        <el-row :gutter="20">
          <el-col :span="3">
            <el-form-item label="前景色">
              <el-color-picker
                v-model="form.options.color.dark"
              ></el-color-picker>
            </el-form-item>
          </el-col>
          <el-col :span="3">
            <el-form-item label="背景色">
              <el-color-picker
                v-model="form.options.color.light"
              ></el-color-picker>
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item label="纠错级别">
          <el-radio v-model="form.options.errorCorrectionLevel" label="L">
            L(7%)
          </el-radio>
          <el-radio v-model="form.options.errorCorrectionLevel" label="M">
            M(15%)
          </el-radio>
          <el-radio v-model="form.options.errorCorrectionLevel" label="Q">
            Q(25%)
          </el-radio>
          <el-radio v-model="form.options.errorCorrectionLevel" label="H">
            H(30%)
          </el-radio>
        </el-form-item>
        <el-form-item>
    ...
    <el-divider />
    <div v-if="imgSrc" style="margin-top: 10px">
      <el-row>
        <el-image :src="imgSrc" />
      </el-row>
      <el-row style="margin-top: 10px">
        <el-button v-if="imgSrc" size="small" type="primary" @click="download">
          下载二维码
        </el-button>
      </el-row>
    </div>
